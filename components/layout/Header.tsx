          ...
          <nav className="hidden lg:flex items-center space-x-14">
            {navItems.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-black hover:text-berry-red-dark font-oswald uppercase text-sm tracking-wider transition-colors duration-200"
              >
                {item.name}
              </Link>
            ))}
            ...
            <div className="flex flex-col space-y-3">
              {navItems.map((item) => (
                <Link
                  key={item.href}
                  href={item.href}
                  className="text-black hover:text-berry-red-dark font-oswald uppercase text-sm tracking-wider transition-colors px-2 py-1"
